...
class _AddEditCategoryState extends State<AddEditCategory> {
  ...
  Future addEditCategory() async {
    if (categoryNameController.text != "") {
      if (editMode) {
        var url = "http://192.168.43.203/kindyywebapp/updateCategory.php";
        ...
        if (response.statusCode == 200) {
          showDialog(
            ...
            builder: (context) => AlertDialog(
              title: Text("Message"),
              content: Text("Category Update Sucessful"),
              actions: [
                RaisedButton(
                  color: Colors.red,
                  onPressed: () {
        ...
        var url = "http://192.168.43.203/kindyywebapp/addCategory.php";
        var response =
