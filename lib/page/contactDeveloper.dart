    ...
    return Scaffold(
      ...
      child: Column(
        children: [
          ...
          Center(
            child: CircleAvatar(
              backgroundColor: Color(0xff080625),
              radius: 80,
              backgroundImage: AssetImage("images/contactDev.jpg"),
            ),
          ...
          Text("Kindy_Dev", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 25, color: Colors.red),),
          Text("Mobile Development (Android /IOS)", style: TextStyle(fontWeight: FontWeight.normal, fontSize: 20, color: Colors.black87),),

          SizedBox(
            height: 10.0,
          ),
          Text("If you have any suggestion or Project Idea You", style: TextStyle(fontWeight: FontWeight.normal, fontSize: 15, color: Colors.black87),),
          SizedBox(
            height: 20.0,
          ),
          // Row(
...
// _instagram() async {
//   const url = "https://www.instagram.com/kindyy01/";
...
//
// launch(String url) {
//   url = "https://www.instagram.com/kindyy01/";
// }
//
